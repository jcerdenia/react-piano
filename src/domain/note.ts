...
// At first glance the following types don't look so useful, since we could just use
// number. The point is in their domain meaning.
...
// Takes a midi value and outputs a Note object.
